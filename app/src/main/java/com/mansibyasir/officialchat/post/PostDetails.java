package com.mansibyasir.officialchat.post;
...
import com.mansibyasir.officialchat.adapter.AdapterComments;
import com.mansibyasir.officialchat.groups.ShareGroupActivity;
import com.mansibyasir.officialchat.model.ModelComments;
...
public class PostDetails extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
     ...
     vine = findViewById(R.id.videoView);
        ...
        HashTagHelper mTextHashTagHelper = HashTagHelper.Creator.create(getResources().getColor(R.color.bluesugar), hashTag -> {
    ...
    private Uri saveImageToShare(Bitmap bitmap) {
        ...
        try {
            ...
            stream.flush();
            stream.close();
            uri = FileProvider.getUriForFile(this, "com.mansibyasir.officialchat.fileprovider", file);
        ...
        if (requestCode == PERMISSION_CODE) {
            if (grantResults.length > 0 && grantResults[0] ==
                ...
                Alerter.create(PostDetails.this)
                        ...
                        .setBackgroundColorRes(R.color.bluesalt)
                        .setDuration(10000)
