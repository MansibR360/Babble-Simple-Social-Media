...
import com.mansibyasir.officialchat.adapter.AdapterChat;
import com.mansibyasir.officialchat.MainActivity;
import com.mansibyasir.officialchat.model.ModelChat;
...
import com.mansibyasir.officialchat.notifications.Data;
import com.mansibyasir.officialchat.notifications.Sender;
                    ...
                    try {
                        ...
                        JsonObjectRequest jsonObjectRequest = new JsonObjectRequest("https://fcm.googleapis.com/fcm/send", jsonObject, new Response.Listener<JSONObject>() {
                            ...
                            public Map<String, String> getHeaders() throws AuthFailureError {
                                ...
                                String sKey = "key=AAAAQvcNhXM:APA91bH1LKY_hDTYhDUlhh3HX2x9yu_jeUg8fdN5H34J5M1clOnenHaW5JrZq-3SiW-GkuIX9KhRil9_YYBAWKKxyq60zZQFngI-Icum5bx0htRBf5vCvj46x8PfHV9zfidBUK0X82Lz";
                                headers.put("Authorization", sKey);
